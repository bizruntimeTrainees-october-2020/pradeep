    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.Use(async (context, next) =>
            {
                ...
                await next();
                await context.Response.WriteAsync(" my second middleware response ");
            ...
            app.Use(async (context, next) =>
            {
                ...
                await next();
                await context.Response.WriteAsync(" my third middleware response ");
            ...
            {
                endpoints.MapGet("/pradeep", async context =>
                {
                    await context.Response.WriteAsync(" Hello pradeep! ");
                });
            });
        }
    }
